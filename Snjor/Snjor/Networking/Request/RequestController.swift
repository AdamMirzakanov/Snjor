...
/// различных данных, таких как фотографии, альбомы, пользователи темы и т.д.
enum RequestController {
  ...
  /// Запрос включает идентификатор темы и путь к фотографиям, а также параметры
