//
//  OldAlbumsViewModelProtocol.swift
//  Snjor
//
//  Created by Адам Мирзаканов on 08.08.2024.
//

protocol OldAlbumsViewModelProtocol: BaseViewModelProtocol {
  var albums: [Album] { get }
  func getAlbum(at index: Int) -> Album
  func getAlbumsViewModelItem(at index: Int) -> OldAlbumsViewModelItem
